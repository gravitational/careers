...
through SSO IDP of of any kind and get a WireGuard public key set up on their
computer to be authorized to access a WireGuard network.

## Requirements

Create automation using Terraform, helm charts, or docker-compose that sets up a
demo environment with the following capabilities:

- Determine implementation, security and scope requirements for the document.
- Present the design to the interview team - a mix of technical and business audience, explain value proposition and answer technical questions to both.
