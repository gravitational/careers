...
* The UI should display the directory hierarchy in a form of tree giving filtering
...
The UI should allow a user to view the contents of a directory and all subdirectories within. 
Directories and files should be represented as nodes, and edges should be used to show the hierarchy.
Clicking on a subdirectory should expand the subdirectory node and show the entities inside it.
...
Your design document should include everything above, as well as:
