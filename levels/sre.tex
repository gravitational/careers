...
% TODO(russjones): Make all columns for all challenges 20em.
...
% TODO(russjones): Apply this to other levels guides as well.
\bigbreak
...
\rowcolor{blue!60!black!10}
    ...
    &
    % TODO(russjones): Update ordering to be product->comm for other guides as well.
